...
def generate_dataset(ldaysTr, z_factor, badpixels=[None,None], lapent=[None, None, None, None]):
    """
...
if __name__ == '__main__':
    ...
    data = generate_dataset(days,0.5, badpixels=[32, 0.2], lapent=[1000,1300,16,4])
    print(data.shape)
