...
"""
import argparse
from Traffic.Process.DatasetProcess import generate_dataset
...
if __name__ == '__main__':
    ...
    if args.lapent is not [None, None, None]:
    ...
    print
    generate_dataset(process_path, days, chunk=chunk, z_factor=z_factor, mxdelay=mxdelay, onlyfuture=False,
                     imgordering=imgord, test=args.test, augmentation=args.augmentation, hourban=(ihour, fhour),
                     badpixels=(nbin, perc), lapent=(lap1, lap2, bins, ent), compress=compress,
